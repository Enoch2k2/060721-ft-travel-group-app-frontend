...
const PointOfInterestForm = () => {
  ...
  const handleSubmit = async e => {
    ...
    //Last check to determine if dummy data is being used.
    if (useDummyData) {
      e.preventDefault()
      console.log('New POI submitted.') //For dummy data, nothing happens. If somebody wants to include this, be my guest :)
    } else {
      e.preventDefault()
      const method = "POST"
